...
import DocSearch from '../lib/doc-search';
...
describe('DocSearch', () => {
  ...
  beforeEach(() => {
    ...
    activationPromise = atom.packages.activatePackage('doc-search');
  });

  describe('when the doc-search:php event is triggered', () => {
    it('hides and shows the modal panel', () => {
      // Before the activation event the view is not on the DOM, and no panel
      // has been created
      expect(workspaceElement.querySelector('.doc-search')).not.toExist();
      ...
      runs(() => {
        expect(workspaceElement.querySelector('.doc-search')).toExist();

        let docSearchElement = workspaceElement.querySelector('.doc-search');
        expect(docSearchElement).toExist();
